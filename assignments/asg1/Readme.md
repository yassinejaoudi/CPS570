...
|---------------|-------------|-----------------|-----------|--------------|------------|-------------|
|  **Running Output**  | 5  | 1<br />1<br />1<br />1<br />1<br />  | Printouts every 2 seconds<br />Correct active threads<br />Correct attempted robots<br />Correct pps<br />  Correct Mbps<br />   | :heavy_check_mark:<br />:heavy_check_mark:<br /><br /><br /><br /> | <br /><br />:heavy_check_mark:<br /><br /><br /> | <br />:heavy_check_mark:<br /><br />:heavy_check_mark:<br />:heavy_check_mark:<br /> | 
|  **Summary**  | 6  | 1<br />1<br />1<br />1<br />1<br />1<br />  | Correct URL processing rate<br />Correct DNS rate<br />Correct robots rate<br />Correct crawled rate/totals<br />Correct parser speed <br />Correct HTTP breakdown <br />  | :heavy_check_mark: <br />:heavy_check_mark:<br /><br /><br /><br /><br /> | <br /><br />:heavy_check_mark:<br />:heavy_check_mark:<br /><br /><br />  |  <br /><br /><br /> <br /> :heavy_check_mark:<br />:heavy_check_mark:<br /> |
